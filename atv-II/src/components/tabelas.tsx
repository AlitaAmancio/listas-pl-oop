...
class ClientesCincoMais extends Component {
  render() {
    return (
...
class ClientesDezMais extends Component {
  render() {
    return (
      <div className='container-fluid'>
        <div className='row'>
...
class ServicosMaisRequisitados extends Component {
  render() {
    return (
      <div className='container-fluid'>
        <div className='row'>
...
export { ClientesCincoMais, ClientesDezMais, ListagemMaisConsumidos, ServicosMaisRequisitados };
